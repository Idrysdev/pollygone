        ...
        <div class="col-xl-8">
            <div class="card-box">
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table-responsive table-stripped  table-hover mb-0">
                        <thead>
                        <tr>
                            <th>#</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('accounts.destroy', $account) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    <a  class="btn-xs btn  btn-icon waves-effect waves-light btn-purple" href="{{ route('accounts.edit', $account->id) }}"><i class="mdi mdi-account-edit"></i></i></a>
                                    <button class="btn-xs btn btn-icon waves-effect waves-light btn-danger"><i class="mdi mdi-account-remove"></i></button>
                                    </form>
